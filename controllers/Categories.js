...
exports.getAllCategories =async (req, res)=>{
    ...
    res.status(StatusCodes.OK).send({...categories})
        ...
        res.status(StatusCodes.BAD_REQUEST).send('There are no categories yet', res)
    }
}
...
exports.getCategory =async (req, res)=>{
    ...
    if(!category || !tasks){
        throw new NotFound(`Category ${req.user.name} does not exist`, res)
    }
...
exports.deleteCategory =async (req, res)=>{
    ...
    if(!category){
        throw new BadRequest(`No category wit id ${req.params.id}`, res)
    }
...
exports.updateCategory =async (req, res)=>{
    ...
    if(name === '' || description ===''){
        throw new BadRequest('Please fill in the name and description fields', res);
    }
    ...
    if(!category){
        throw new NotFound(`No category wit id ${req.params.id}`, res)
    }
